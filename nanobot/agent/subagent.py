...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        *,
        announce: bool = True,
        # Ziggy-local (fork, MIT-202): links this subagent under the parent
        # turn's Langfuse trace (same trace_id, new parent_span_id).
        ...
        *,
        ...
        try:
            ...
            try:
                ...
                # spans opened inside runner.run() nest under it, giving the
                # "turn -> subagent -> iteration -> tool" hierarchy. No-op when
