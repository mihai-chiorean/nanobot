...
class ReasoningProfile(StrEnum):
    ...
    AUTO = "auto"
    FAST = "fast"
    DEEP = "deep"  # 0.3.0 chat wire value for the high-effort tier
    THINK = "think"
...
_PROFILES = {
    ...
    # 0.3.0 chat surface: ThreadComposer sends "deep" for Deep thinking; it
    # resolves to the same high-effort tier as the Work-side "think" value.
    ReasoningProfile.DEEP: GenerationProfile(
        name=ReasoningProfile.DEEP,
