...
class ReportProgressTool(Tool):
    """Publish a human-readable progress step for the Work surface."""
...
@tool_parameters(
    tool_parameters_schema(
        ...
        kind=StringSchema("Artifact kind", enum=["markdown", "file", "report", "patch", "command_log"]),
...
class PublishArtifactTool(Tool):
    """Publish a durable local artifact for the Work surface."""
